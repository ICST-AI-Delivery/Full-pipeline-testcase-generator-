...
Usage:
    ...
    python scripts/generate_srs_analysis.py --phase 2 --feature VEH-F165_Manettino
    python scripts/generate_srs_analysis.py --phase 3 --feature VEH-F165_Manettino
    python scripts/generate_srs_analysis.py --phase 4 --feature VEH-F165_Manettino
    python scripts/generate_srs_analysis.py --phase 5 --feature VEH-F165_Manettino
"""
...
class SRSAnalysisGenerator:
    def __init__(self, api_key=None):
        ...
        self.analysis_results_dir = self.project_root / "analysis_results"
        self.data_files_dir = self.project_root / "data_files"
        self.srs_export_dir = self.project_root / "SRS Export"
    ...
    def find_srs_file(self, feature_name):
        ...
        srs_base_dirs = [
            self.srs_export_dir,  # SRS Export/
            self.srs_export_dir / "SRS Export",  # SRS Export/SRS Export/
            self.project_root / "Pre-FineTuneLearning Model" / "SRS FPI export"  # Pre-FineTuneLearning Model/SRS FPI export/
        ]
...
Please ensure the SRS requirements file is placed in the correct location."""
    ...
    def load_srs_prompt_template(self):
        ...
        template_file = self.project_root / "SRS_Analysis_TestCase_Generation.txt"
        
        if not template_file.exists():
            raise FileNotFoundError("SRS_Analysis_TestCase_Generation.txt not found")
